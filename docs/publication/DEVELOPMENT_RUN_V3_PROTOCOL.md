...
The preceding hardened package passes the independent verifier with package receipt `02de5983fca6f82b56ed0c0c01ec0a79139c9f588098f3003084eb215f5ee7ba` and evaluation receipt `a2e94006b8164d7c47c4706beaf37bbfd6cf53e7f19267fa5e25a966e7731697`. It evaluates and preserves all 12 development rows, four per input mode, across two animal units; all raw predictions are bound to their exact cache rows and per-row S=9 schedules. The independently replayed cache scientific audit at commit `3e39887bda6c6fc77c7bb0b8632958563d7762b9` matches receipt `8e2e5033b003ee41378932e20147c760b8b635426992c1fc584958b8b6a43706` exactly and passes all contractual provenance, no-drop, PSF, supervision, optional-brush, finite-value, and identity-disjointness gates.

Verifier hardening at implementation commit `e52648af2bc2cead7097a72650ef9d8d4977dc29` closed the remaining regional-overlap replay limitation. A clean worktree pinned to exact source `88cc51cd519245d123898775cdd0bea4fcd6301e` repackaged the same completed smoke run into the new immutable directory `I:\AnatomyTracker\runs\arbitrary_plane_finite_v4_smoke_001\finite_postrun_v4_annotation_bound`; the preceding package remains immutable and was not overwritten. The new package binds a compressed annotation-only AP/DV/ML `uint32` artifact (shape 528 by 320 by 456, 25-micrometre isotropic voxels, no atlas intensity) under file SHA-256 `af3e3f06ee84fdf57ab68a11cec2dc5e053f1671324097f88aab99b0400def6e` and decoded tensor SHA-256 `36ed7e196bc41a850071246ed1d182f6331157df3a51b1145144848874025ad3`. The independent verifier decodes it with pickling disabled, cross-binds it to the checkpoint and Allen annotation source, and recomputes regional overlap from every saved CPU raw prediction. It passes under package receipt `d685113d6312012894e917046303087c26868da99011c70535762a9b197c857a` and evaluation receipt `45474641add0851f6aedc46c3e50650b35dbfc41a35fe9932ea03132552d0c0a`; all 12 raw file hashes and prediction receipts match and the exact package contains 18 files.

Scientific quality is nevertheless a clear **FAIL / NOT ESTABLISHED** and is unchanged by this verifier-only repackaging. All 12 rows failed and animal-macro top-k recall is zero. Across the two animal units, physical finite-frame landmark error is 11,670.371996520109 micrometres, absolute plane-offset error is 3,591.523626490142 micrometres, projective-normal error is 57.03649442936318 degrees, finite-frame rotation error is 129.5270215366854 degrees, and foreground Dice is 0.0006351621244078951. Scores and covariances remain explicitly uncalibrated, with no coverage claim. The engineering path remains **PASS**, but the next gate is improved honest coarse retrieval and a newly trained receipt-bound finite S=9 pilot with materially better all-row animal-disjoint pose and overlap results before calibration or public benchmarking. Exact evidence is recorded in `arbitrary_plane_finite_v4_smoke_result.yaml`.
